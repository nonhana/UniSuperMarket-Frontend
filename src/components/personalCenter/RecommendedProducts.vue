<template>
  <view class="RecommendedProducts-wrap">
    <view class="head">
      <img class="head-icon" src="../../static/svg/TitleLeft.svg" />
      <text>为你推荐</text>
      <img class="head-icon" src="../../static/svg/TitleRight.svg" />
    </view>
    <tm-waterfall :width="690">
      <tm-waterfall-item
